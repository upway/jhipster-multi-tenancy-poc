 ...
 */
@Configuration
@EnableJpaRepositories(basePackages  = "com.mycompany.myapp.tenancy.repository", entityManagerFactoryRef = "tenancyEntityManager",transactionManagerRef = "transactionManager")
...
public class TenancyConfiguration implements EnvironmentAware {
    ...
    public LocalContainerEntityManagerFactoryBean tenancyEntityManager() throws Throwable {
        ...
        entityManager.setPackagesToScan("com.mycompany.myapp.tenancy.domain");
    ...
    public DataSource tenancyDataSource() {
        ...
        if (propertyResolver.getProperty("url") == null || "".equals(propertyResolver.getProperty("url"))) {
            ...
            config.addDataSourceProperty("url","jdbc:mysql://localhost:3306/jhipster");
        }
